...
typedef enum {
    ...
    IVS_FACECAP_DETECT,                             /**< DL人脸抓拍 */
    IVS_PERSON_DETECT,                              /**< DL人形检测 */
    IVS_FACEPERSON_DETECT,                          /**< DL人脸人形宠物(猫狗)检测 */
    IVS_PASSENGER_FS_DETECT,                        /**< DL客流统计 */
    IVS_FACEPERSONPET_DETECT,                       /**< DL人脸人形宠物(猫狗)检测 */
    IVS_PERSONPET_DETECT,                           /**< DL人形宠物(猫狗)检测 */
...
/**
 * @fn IMPIVSInterface *FacepersonDetInterfaceInit(void *param)
 *
 * DL人脸人形检测接口初始化结构体
 *
 * @param[in] DL人脸人形检测初始化参数
 *
 * @retval NULL 失败
 * @retval 非NULL 初始化成功，返回DL人脸人形检测接口结构体指针句柄
 *
 * @attention 无。
 */

IMPIVSInterface *FacepersonDetInterfaceInit(void* param);

/**
 * @fn void FacepersonDetInterfaceExit(IMPIVSInterface *inf)
 *
 * DL人脸人形检测接口去初始化结构体
 *
 * @inf[in] DL人脸人形检测接口结构体指针句柄
 *
 * @attention 无。
 */
void FacepersonDetInterfaceExit(IMPIVSInterface *inf);


/**
 * @fn IMPIVSInterface *FacePersonPetDetInterfaceInit(void *param)
 *
 * DL人脸人形宠物(猫狗)检测接口初始化结构体
 *
 * @param[in] DL人脸人形宠物(猫狗)检测初始化参数
 *
 * @retval NULL 失败
 * @retval 非NULL 初始化成功，返回DL人脸人形宠物(猫狗)检测接口结构体指针句柄
 *
 * @attention 无。
 */

IMPIVSInterface *FacePersonPetDetInterfaceInit(void* param);

/**
 * @fn void FacePersonPetDetInterfaceExit(IMPIVSInterface *inf)
 *
 * DL人脸人形宠物(猫狗)检测接口去初始化结构体
 *
 * @inf[in] DL人脸人形宠物(猫狗)检测接口结构体指针句柄
 *
 * @attention 无。
 */
void FacePersonPetDetInterfaceExit(IMPIVSInterface *inf);


/**
 * @fn IMPIVSInterface *PersonPetDetInterfaceInit(void *param)
 *
 * DL人形宠物(猫狗)检测接口初始化结构体
 *
 * @param[in] DL人形宠物(猫狗)检测初始化参数
 *
 * @retval NULL 失败
 * @retval 非NULL 初始化成功，返回DL人形宠物(猫狗)检测接口结构体指针句柄
 *
 * @attention 无。
 */

IMPIVSInterface *PersonpetDetInterfaceInit(void* param);

/**
 * @fn void PersonPetDetInterfaceExit(IMPIVSInterface *inf)
 *
 * DL人形宠物(猫狗)检测接口去初始化结构体
 *
 * @inf[in] DL人形宠物(猫狗)检测接口结构体指针句柄
 *
 * @attention 无。
 */
void PersonpetDetInterfaceExit(IMPIVSInterface *inf);


/**
 * @fn IMPIVSInterface *BabyDetInterfaceInit(void *param)
 *
 * DL baby检测接口初始化结构体
 *
 * @param[in] DL baby检测初始化参数
 *
 * @retval NULL 失败
 * @retval 非NULL 初始化成功，返回DL baby检测接口结构体指针句柄
 *
 * @attention 无。
 */

IMPIVSInterface *BabyDetInterfaceInit(void* param);

/**
 * @fn void BabyDetInterfaceExit(IMPIVSInterface *inf)
 *
 * DL baby检测接口去初始化结构体
 *
 * @inf[in] DL baby检测接口结构体指针句柄
 *
 * @attention 无。
 */
void BabyDetInterfaceExit(IMPIVSInterface *inf);
...
/**
 * @fn IMPIVSInterface *Person_TrackerInterfaceInit(void* param)
 *
 * DL人形追踪检测接口初始化结构体
 *
 * @param[in] DL人形追踪检测初始化参数
 *
 * @retval NULL 失败
 * @retval 非NULL 初始化成功，返回DL人形追踪检测接口结构体指针句柄
 *
 * @attention 适用于全景摄像机。
 */
IMPIVSInterface *Person_TrackerInterfaceInit(void* param);

/**
 * @fn void Person_TrackerInterfaceExit(IMPIVSInterface *inf)
 *
 * DL人形追踪检测接口去初始化结构体
 *
 * @inf[in] DL人形追踪检测接口结构体指针句柄
 *
 * @attention 适用于全景摄像机。
 */
void Person_TrackerInterfaceExit(IMPIVSInterface *inf);
...
IMPIVSInterface *FaceCapInterfaceInit(void *param);
 ...
 * @attention 无
 */
void FaceCapInterfaceExit(IMPIVSInterface *inf);
...
/**
 * @fn IMPIVSInterface *PassengerFSInterfaceInit(void *param)
 *
 * 客流统计
 *
 * @param[in] 客流统计检测初始化参数
 *
 * @retval NULL 失败
 * @retval 非NULL 初始化成功，返回CV人脸检测接口结构体指针句柄
 *
 * @attention 无。
 */
IMPIVSInterface *PassengerFSInterfaceInit(void *param);

/**
 * @fn void PassengerFSInterfaceExit(IMPIVSInterface *inf)
 *
 * 客流统计检测接口去初始化结构体
 *
 * @inf[in] 客流统计测接口结构体指针句柄
 *
 * @attention 无。
 */
void PassengerFSInterfaceExit(IMPIVSInterface *inf);
