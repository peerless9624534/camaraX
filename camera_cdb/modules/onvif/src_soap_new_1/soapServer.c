...
SOAP_SOURCE_STAMP("@(#) soapServer.c ver 2.8.124 2023-02-16 05:51:15 GMT")
...
SOAP_FMAC5 int SOAP_FMAC6 soap_serve_request(struct soap *soap)
{
    ...
    /*测试log，调试时打开*/
    //printf("=====Receieved Tag:%s\n", soap->tag);
    /*printf("*********soap_serve_request**********_index:%d\n", soap->nlist->index);
    printf("*********soap_serve_request**********_ns:%s\n", soap->nlist->ns);
    printf("*********soap_serve_request**********_id 0:%d\n", soap->nlist->id[0]);
    printf("*********soap_serve_request**********_id_1:%d\n", soap->nlist->id[1]);*/
