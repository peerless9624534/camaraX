...
OPERATE_RET tuya_ipc_ring_buffer_append_data_with_timestamp(CHANNEL_E channel, UCHAR_T *addr, UINT_T size, MEDIA_FRAME_TYPE_E type, UINT64_T pts, UINT64_T timestamp);
...
*/
Ring_Buffer_Node_S *tuya_ipc_ring_buffer_get_av_frame(CHANNEL_E v_channel, CHANNEL_E a_channel, USER_INDEX_E userIndex, BOOL_T isRetry);
...
*/
Ring_Buffer_Node_S *tuya_ipc_ring_buffer_get_next_target_frame(CHANNEL_E channel, USER_INDEX_E userIndex, UINT_T seqNo, MEDIA_FRAME_TYPE_E type);
...
*/
OPERATE_RET tuya_ipc_ring_buffer_anchor_user(CHANNEL_E channel,USER_INDEX_E userIndex, UINT_T frameNum, BOOL_T checkOverlap);
