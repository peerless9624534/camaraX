...
typedef struct tagC2C_TRANS_CTRL_PB_START_V2{
    unsigned int channel;
    PLAYBACK_TIME_S time_sect;
    UINT_T playTime;  /* the actual playback time, in second */
    TRANSFER_SOURCE_TYPE_E type;
}C2C_TRANS_CTRL_PB_START_V2;
...
/***********************************************************
*  Function: tuya_ipc_get_client_online_num
*  Note:  user get p2p connect num
*  Input: NULL
*  Output: none
*  Return: -1/num
***********************************************************/
...
/***********************************************************
*  Function: tuya_ipc_p2p_user_recv_data
*  Note:  user recv data from p2p channel
*  Input: client:user get from event_cb
*  Output: none
*  Return: >=0/OK  -3/timeout other/FAIL
***********************************************************/
INT_T tuya_ipc_p2p_user_recv_data(IN CONST UINT_T client, IN UINT8_T * recv_buf, INOUT INT_T * recv_len);

/***********************************************************
*  Function: tuya_ipc_p2p_user_send_data
*  Note:  user send data from p2p channel
*  Input: client:user get from event_cb
*  Output: none
*  Return: send_len/OK  -6/buff is full  other/FAIL
***********************************************************/
INT_T tuya_ipc_p2p_user_send_data(IN CONST UINT_T client, IN UINT8_T * send_buf, IN INT_T send_len);
